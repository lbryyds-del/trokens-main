...
def add_custom_config(cfg):
    ...
    cfg.FEW_SHOT.POT_ROUTE.TEMPORAL_REFINEMENT.COST_DIM = 16
    cfg.FEW_SHOT.POT_ROUTE.TEMPORAL_REFINEMENT.GUIDANCE_DIM = 16
    cfg.FEW_SHOT.POT_ROUTE.TEMPORAL_REFINEMENT.ATTENTION_DIM = 16
    cfg.FEW_SHOT.POT_ROUTE.TEMPORAL_REFINEMENT.RADIUS = 2
